...
var depositRoutes = require("./routes/deposit.routes");
var interestRateRoutes = require("./routes/interest.rate.routes");
var cors = require("cors");
var Staking = require("./models/Staking");
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          setInterval(function () {
            axios.get('https://stakingusdt-bek.onrender.com/api/user/users').then(function () {
              return console.log('Pinged server');
            })["catch"](function (err) {
